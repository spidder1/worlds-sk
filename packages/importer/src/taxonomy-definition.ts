    ...
    subcategories: [
      {
        ...
        subcategories: [
          ...
          },
          {
            ...
            subcategories: [
              { id: 'cat-tasky-a-puzdra', slug: 'tasky-a-puzdra-na-notebooky', name: 'Tašky, batohy a puzdrá na notebooky', parentSlug: 'prislusenstvo-k-notebookom', level: 4, isSeoIndexed: true, displayOrder: 1, allowedFilterAttributes: ['brand'] },
              { id: 'cat-baterie-a-adaptery', slug: 'baterie-a-adaptery-k-notebookom', name: 'Batérie a adaptéry k notebookom', parentSlug: 'prislusenstvo-k-notebookom', level: 4, isSeoIndexed: true, displayOrder: 2, allowedFilterAttributes: ['brand'] },
              { id: 'cat-chladenie-stojany-nb', slug: 'chladenie-a-stojany-na-notebooky', name: 'Chladiace podložky a stojany', parentSlug: 'prislusenstvo-k-notebookom', level: 4, isSeoIndexed: true, displayOrder: 3, allowedFilterAttributes: ['brand'] },
              { id: 'cat-ochranne-folie-skla', slug: 'ochranne-folie-a-skla', name: 'Ochranné fólie a sklá', parentSlug: 'prislusenstvo-k-notebookom', level: 4, isSeoIndexed: true, displayOrder: 4, allowedFilterAttributes: ['brand'] },
              { id: 'cat-pera-a-stylusy', slug: 'pera-a-stylusy', name: 'Dotykové perá a stylusy', parentSlug: 'prislusenstvo-k-notebookom', level: 4, isSeoIndexed: true, displayOrder: 5, allowedFilterAttributes: ['brand'] },
            ],
          },
        ],
      },
...
export function classifyProductIndependently(item: ProductInputFields): { slug: string; hierarchy: string[] } {
  ...
  if (isAccessory && /\b(notebook|laptop|ntb)\b/.test(fullText)) {
    return { slug: 'prislusenstvo-k-notebookom', hierarchy: ['Počítače a notebooky', 'Notebooky', 'Príslušenstvo k notebookom'] };
  }
