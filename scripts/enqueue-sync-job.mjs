...
const allowed = new Set(['catalog-full', 'stock-price', 'image-loader', 'manufacturer-cleanup', 'transport-dictionary', 'supplier-orders', 'search-drain', 'search-reindex', 'reference-data']);
